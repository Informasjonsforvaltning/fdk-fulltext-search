...
class DataServiceQuery(AbstractSearchQuery):
    ...
    def add_search_string(self, search_string: str):
        dismax_queries = [
            index_match_in_title_query(index_key=IndicesKey.DATA_SERVIES,
                                       search_string=search_string),
            word_in_description_query(index_key=IndicesKey.DATA_SERVIES,
                                      search_string=search_string,
                                      autorativ_boost=False),
            simple_query_string(search_string=search_string,
                                all_indices_autorativ_boost=False,
                                boost=0.02),
            # fields_for_index=IndicesKey.DATA_SERVIES),
            simple_query_string(search_string=search_string,
                                all_indices_autorativ_boost=False,
                                lenient=True)
            # fields_for_index=IndicesKey.DATA_SERVIES)
